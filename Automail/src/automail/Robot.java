...
public class Robot {
    ...
    private ChargeDatabase chargeDatabase;
     ...
     */
    public Robot(IMailDelivery delivery, MailPool mailPool, ChargeDatabase chargeDatabase, int number){
    	this.id = "R" + number;
    	...
    	switch(current_state) {
    		...
    		case DELIVERING:
    			if(current_floor == destination_floor){ // If already here drop off either way
	                ...
	                /** Update move cost of mail in charge database */
	                chargeDatabase.updateMoveCost(deliveryItem.id);
    			}
                break;
    	}
    }
